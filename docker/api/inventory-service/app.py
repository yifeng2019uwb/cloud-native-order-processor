...
class InventoryManager:
    ...
    def get_products(
        self, limit: int = 50, category: str = None, low_stock_only: bool = False
    ) -> List[Dict]:
        ...
        try:
            ...
            if low_stock_only:
                products = [
                    p
                    for p in products
                    if (p.get("stock_quantity", 0) - p.get("reserved_quantity", 0))
    ...
    def delete_product(self, product_id: str) -> bool:
        ...
        try:
            ...
            with self.db.get_connection() as conn:
                ...
                cursor.execute(
                    "DELETE FROM inventory WHERE product_id = %s", (product_id,)
                )
    ...
    def update_stock(
        self, product_id: str, quantity_change: int, reason: str = None
    ) -> bool:

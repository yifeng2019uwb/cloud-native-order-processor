...
class OrderProcessor:
    ...
    def list_orders(self, limit: int = 50, status: str = None, customer_email: str = None) -> List[Dict]:
        ...
        try:
            ...
            if customer_email:
                orders = [order for order in orders if order['customer_email'] == customer_email]

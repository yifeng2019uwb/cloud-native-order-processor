...
# User Service Deploy Script
# This script sets up the environment and starts the user service
...
if [[ ! -f "src/main.py" ]]; then
    echo -e "${RED}❌ Error: src/main.py not found. Please run this script from the user_service directory.${NC}"
    exit 1
fi

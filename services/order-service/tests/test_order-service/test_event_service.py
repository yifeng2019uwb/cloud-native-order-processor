...
class TestEventService:
    ...
    @pytest.mark.asyncio
    async def test_publish_order_event_success_both_services(self, event_service, sample_order_response):
    ...
    @pytest.mark.asyncio
    async def test_publish_order_event_sns_only(self, event_service, sample_order_response):
    ...
    @pytest.mark.asyncio
    async def test_publish_order_event_s3_only(self, event_service, sample_order_response):
        ...
        await event_service.publish_order_event("order_cancelled", sample_order_response)
    ...
    @pytest.mark.asyncio
    async def test_publish_order_event_no_services_configured(self, event_service, sample_order_response):
    ...
    @pytest.mark.asyncio
    async def test_publish_order_event_sns_failure(self, event_service, sample_order_response):
    ...
    @pytest.mark.asyncio
    async def test_publish_order_event_s3_failure(self, event_service, sample_order_response):
    ...
    @pytest.mark.asyncio
    async def test_publish_order_event_event_creation(self, event_service, sample_order_response):
    ...
    @pytest.mark.asyncio
    async def test_publish_order_event_invalid_event_type(self, event_service, sample_order_response):
        """Test handling of invalid event type."""
        event_service.sns_topic_arn = "arn:aws:sns:us-west-2:123456789:test-topic"

        # Should handle invalid event type gracefully
        with patch('builtins.print') as mock_print:
            await event_service.publish_order_event("invalid_event_type", sample_order_response)
    ...
    @pytest.mark.asyncio
    async def test_publish_order_event_with_valid_event_types(self, event_service, sample_order_response):

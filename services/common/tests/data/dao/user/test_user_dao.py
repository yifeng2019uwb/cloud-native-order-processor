...
from src.data.entities.user import UserCreate, User, UserLogin
...
class TestUserDAO:
    ...
    def test_authenticate_user_not_found(self, user_dao):
        ...
        user_dao.get_user_by_username = Mock(side_effect=CNOPEntityNotFoundException("User 'nonexistent' not found"))

        # Should raise CNOPEntityNotFoundException

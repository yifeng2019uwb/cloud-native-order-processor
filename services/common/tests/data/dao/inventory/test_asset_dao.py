...
from src.data.entities.inventory import AssetCreate, Asset, AssetUpdate
...
class TestAssetDAO:
    ...
    def test_datetime_handling_in_create_asset(self, asset_dao, sample_asset_create, mock_db_connection):
        ...
        with patch('src.data.dao.inventory.asset_dao.datetime') as mock_datetime:
    ...
    def test_methods_with_empty_strings(self, asset_dao, mock_db_connection):
        ...
        # Should raise CNOPDatabaseOperationException (wraps EntityNotFoundException) for empty string
        with pytest.raises(CNOPDatabaseOperationException):

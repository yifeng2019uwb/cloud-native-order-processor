...
class TestGetLockInfo:
    ...
    def test_get_lock_info_exists_and_valid(self):
    ...
    def test_get_lock_info_not_exists(self):
    ...
    def test_get_lock_info_expired(self):
    ...
    def test_get_lock_info_database_error(self):
        ...
        with patch('common.utils.lock_manager.dynamodb_manager') as mock_db_manager:
            ...
            with pytest.raises(DatabaseOperationException, match="Failed to get lock info"):
                get_lock_info(user_id)


class TestCleanupExpiredLocks:
    """Test cleanup_expired_locks function"""

    def test_cleanup_expired_locks_success(self):
    ...
    def test_cleanup_expired_locks_no_locks(self):
    ...
    def test_cleanup_expired_locks_partial_failure(self):
    ...
    def test_cleanup_expired_locks_database_error(self):

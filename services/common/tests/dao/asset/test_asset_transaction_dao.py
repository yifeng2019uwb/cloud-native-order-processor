...
from common.dao.asset.asset_transaction_dao import AssetTransactionDAO
from common.entities.asset import (
    AssetTransaction,
...
from common.exceptions.shared_exceptions import TransactionNotFoundException
...
class TestAssetTransactionDAO:
    ...
    def test_get_asset_transaction_not_found(self, asset_transaction_dao, mock_db_connection):
        ...
        # Should raise TransactionNotFoundException

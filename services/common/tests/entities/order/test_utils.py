...
from src.entities.order.utils import OrderIdGenerator, OrderStatusManager, OrderValidationUtils, OrderBusinessRules, OrderStatusTransition
from src.entities.order.enums import OrderType, OrderStatus
from src.exceptions.shared_exceptions import OrderValidationException
...
class TestOrderIdGenerator:
    ...
    def test_parse_order_id_invalid_format(self):
        ...
        with pytest.raises(OrderValidationException, match="Invalid order ID format"):

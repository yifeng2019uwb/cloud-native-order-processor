...
class TestPasswordManager:
    ...
    def test_validate_password_strength_too_short(self):
        ...
        with pytest.raises(CNOPEntityValidationException, match="Password must be at least 8 characters long"):
    ...
    def test_validate_password_strength_very_long(self):
        ...
        with pytest.raises(CNOPEntityValidationException, match="Password must be no more than 128 characters long"):
